...
MOCK_INTERNAL_METADATA_CATALOG = {
    "identity": {
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/identity",
        "prefix": "http://128.224.180.14:5000",
        "suffix": "v3"
    },
    "patching": {
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/patching",
        "suffix": "",
    ...
    "orchestration": {
        ...
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/orchestration"
    },
    "volume": {
        "prefix": "http://128.224.180.14:8776",
        "suffix": "v1/fcca3cc49d5e42caae15459e27103efc",
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/volume"
    },
    "metering": {
        "suffix": "",
        "prefix": "http://128.224.180.14:8777",
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/metering"
    },
    "volumev3": {
        "prefix": "http://128.224.180.14:8776",
        "suffix": "v3/fcca3cc49d5e42caae15459e27103efc",
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/volumev3"
    },
    "compute": {
        "suffix": "v2.1/fcca3cc49d5e42caae15459e27103efc",
        "prefix": "http://128.224.180.14:8774",
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/compute"
    },
    "platform": {
        "prefix": "http://128.224.180.14:6385",
        "suffix": "v1",
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/platform"
    },
    "nfv": {
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/nfv",
        "prefix": "http://128.224.180.14:4545",
        "suffix": ""
    },
    "volumev2": {
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/volumev2",
    ...
    "image": {
        ...
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/image"
    },
    "network": {
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/network",
    ...
    "alarming": {
        ...
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/alarming"
    },
    "cloudformation": {
        "proxy_prefix": "http://172.16.77.20:9003/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/cloudformation",
...
class TestServiceProxy(unittest.TestCase):
    ...
    def test_get_token(self, mock_get_vim_info, mock_get_token_cache, mock_get_session):
        ...
        response = self.client.head(
            "/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/compute/v2.1/fcca3cc49d5e42caae15459e27103efc/servers",
    ...
    def test_expired_auth_token(self, mock_get_vim_info):
        ...
        response = self.client.get("/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/compute/v2.1/fcca3cc49d5e42caae15459e27103efc/servers",
                                   {}, HTTP_X_AUTH_TOKEN=MOCK_TOKEN_ID)
        self.assertEquals(status.HTTP_403_FORBIDDEN, response.status_code)
    ...
    def test_request_without_servicetype(self, mock_get_vim_info, mock_get_token_cache):
        ...
        mock_get_token_cache.return_value = (json.dumps(MOCK_AUTH_STATE), {})
        servicetype = "compute"
        base_url = "/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/"
    ...
    def test_crud_resources(self, mock_get_token_cache, mock_update_token_cache, mock_get_auth_state, mock_get_session, mock_get_vim_info):
        ...
        response = self.client.delete(
            "/api/multicloud-ocata/v0/windriver-hudson-dc_RegionOne/compute/v2.1/fcca3cc49d5e42caae15459e27103efc/servers/324dfb7d-f4a9-419a-9a19-237df04b443b",
            HTTP_X_AUTH_TOKEN=MOCK_TOKEN_ID)
