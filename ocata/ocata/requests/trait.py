...
class Traits(APIView):
    ...
    def get(self, request, vimid="", tenantid="", traitname=""):
        ...
        try:
            ...
            content, status_code = self.get_traits(sess, query, traitname)
    ...
    def get_traits(self, sess, query="", traitname=""):
        logger.debug("Traits--get_traits::> %s" % traitname)
    ...
    def put(self, request, vimid="", tenantid="", traitname=""):
        ...
        try:
            ...
            content, status_code = self.get_traits(sess, traitname=traitname)
