...
MOCK_VIM_INFO = {
    ...
    'cloud_extra_info':
        '{"vesagent_config":{"backlogs":[{"source": "onap-aaf","domain": "fault","type": "vm","tenant": "VIM"}],"poll_interval_default":10,"ves_subscription":{"username": "user","password": "password","endpoint": "http://127.0.0.1:9009/sample"}}}',
    'insecure': 'True',
}
    ...
    def test_getBacklogsOneVIM(self, mock_get):
        mock_vesagent_config = {"backlogs": [{"backlog_uuid": "ce2d7597-22e1-4239-890f-bc303bd67076",
                                ...
                                "subscription": {"username": "user", "password": "password",
                                                 "endpoint": "http://127.0.0.1:9009/sample"}}
