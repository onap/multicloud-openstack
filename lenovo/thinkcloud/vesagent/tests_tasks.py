...
from thinkcloud.vesagent import tasks
from thinkcloud.vesagent.event_domain import fault_vm
...
class VesTaskTest(unittest.TestCase):
    ...
    def test_tasks_scheduleBacklogs(self, mock_get_vim_by_id, mock_processBacklogs):
        ...
        result = tasks.scheduleBacklogs(vimid="lenovo-hudson-dc_RegionOne")
    ...
    def test_tasks_processBacklogsOfOneVIM(self, mock_cache_get, mock_cache_set, mock_tasks_processOneBacklog):
        ...
        result = tasks.processBacklogsOfOneVIM(vimid="lenovo-hudson-dc_RegionOne")
