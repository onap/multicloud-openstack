...
from thinkcloud.vesagent.tasks import scheduleBacklogs
...
class VesAgentCtrlTest(unittest.TestCase):
    ...
    def test_get(self, mock_get_vim_by_id, mock_get):
        ...
        response = self.client.get("/api/multicloud-thinkcloud/v0/lenovo-hudson-dc_RegionOne/vesagent")
    ...
    def test_post(self, mock_get_vim_by_id, mock_buildBacklogsOneVIM):
        ...
        response = self.view.post(request=mock_request, vimid="lenovo-hudson-dc_RegionOne")
    ...
    def test_delete(self, mock_get_vim_by_id, mock_clearBacklogsOneVIM):
        ...
        response = self.view.delete(request=mock_request, vimid="lenovo-hudson-dc_RegionOne")
    ...
    def test_getBacklogsOneVIM(self, mock_get):
        ...
        vesAgentConfig = self.view.getBacklogsOneVIM(vimid="lenovo-hudson-dc_RegionOne")
    ...
    def test_clearBacklogsOneVIM(self, mock_get, mock_set):
        mock_VesAgentBacklogs_vimlist = ["lenovo-hudson-dc_RegionOne"]
        mock_vesagent_config = {
            "backlogs": [
                {
                    "backlog_uuid": "ce2d7597-22e1-4239-890f-bc303bd67076",
        ...
        result = self.view.clearBacklogsOneVIM(vimid="lenovo-hudson-dc_RegionOne")
    ...
    def test_buildBacklogsOneVIM(self, mock_get, mock_set, mock_scheduleBacklogs_delay):
        ...
        VesAgentBacklogsConfig = self.view.buildBacklogsOneVIM(vimid="lenovo-hudson-dc_RegionOne",
