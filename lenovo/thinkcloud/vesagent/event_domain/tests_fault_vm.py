...
from thinkcloud.vesagent import vespublish
...
MOCK_vesAgentConfig = {
    ...
    "poll_interval_default": 10, "vimid": "lenovo-hudson-dc_RegionOne",
    "ves_subscription": {
...
class FaultVMTest(unittest.TestCase):
    ...
    def test_buildBacklog_fault_vm(self, mock_call_req):
        ...
        backlog = fault_vm.buildBacklog_fault_vm(vimid="lenovo-hudson-dc_RegionOne",
