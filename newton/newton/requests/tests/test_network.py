...
MOCK_DELETE_NETWORK_RESPONSE = {
    "network": {}
}


class mock_network_response_specs(object):
    status_code = 200
    content = ''
...
class TestNetwork(unittest.TestCase):
   ...
   def test_get(self, mock_get_vim_info, mock_get_session,
                mock_get_auth_state, mock_update_token_cache, mock_get_token_cache):
      ...
      mock_get_networks_response_obj = mock.Mock(spec=mock_network_response_specs)
      ...
      # TODO(sshank): Check if /networks endpoint is getting hit.
      response = self.client.get(
         "/api/multicloud-newton/v0/windriver-hudson-dc_RegionOne/fcca3cc49d5e42caae15459e27103efc/networks/", {}, HTTP_X_AUTH_TOKEN=MOCK_TOKEN_ID)
   ...
   @mock.patch.object(VimDriverUtils, 'update_token_cache')
   @mock.patch.object(VimDriverUtils, 'get_token_cache')
   def test_post(self, mock_get_vim_info, mock_get_session, mock_get_auth_state, mock_update_token_cache,
      ...
      mock_session = mock.Mock(name='mock_session', spec=mock_session_specs)
      mock_post_network_response_obj = mock.Mock(spec=mock_network_response_specs)
      mock_post_network_response_obj.status_code = 200
      mock_post_network_response_obj.content = MOCK_GET_NETWORKS_RESPONSE
      mock_post_network_response_obj.json.return_value = MOCK_GET_NETWORKS_RESPONSE
   ...
   @mock.patch.object(VimDriverUtils, 'update_token_cache')
   @mock.patch.object(VimDriverUtils, 'get_token_cache')
   def test_delete(self, mock_get_vim_info, mock_get_session, mock_get_auth_state, mock_update_token_cache,
                   mock_get_token_cache):
      ...
      mock_session = mock.Mock(name='mock_session', spec=mock_session_specs)
      mock_delete_network_response_obj = mock.Mock(spec=mock_network_response_specs)
      mock_delete_network_response_obj.status_code = 200
      mock_delete_network_response_obj.content = MOCK_GET_NETWORKS_RESPONSE
      mock_delete_network_response_obj.json.return_value = MOCK_GET_NETWORKS_RESPONSE
      ...
      response = self.client.delete(
         "/api/multicloud-newton/v0/windriver-hudson-dc_RegionOne/fcca3cc49d5e42caae15459e27103efc/networks/1",
